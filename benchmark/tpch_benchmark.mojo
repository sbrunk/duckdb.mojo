...
fn main() raises:
    ...
    print("  part rows:     " + String(p_chunk.get[Int64](col=0, row=0)))
    ...
    print("  mojo_multiply type: " + String(tc.get[String](col=0, row=0)))
    print("  native * type:      " + String(tc.get[String](col=1, row=0)))
