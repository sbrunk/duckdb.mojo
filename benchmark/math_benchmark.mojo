...
fn main() raises:
    ...
    print("  math_data rows: " + String(rc.get[Int64](col=0, row=0).value()))
    ...
    if F == DType.float64:
        print(
            "  sqrt: std="
            + String(ck.get[Float64](col=0, row=0).value())
            + " mojo="
            + String(ck.get[Float64](col=1, row=0).value())
        )
        print(
            "  sin:  std="
            + String(ck.get[Float64](col=2, row=0).value())
            + " mojo="
            + String(ck.get[Float64](col=3, row=0).value())
        )
    else:
        print(
            "  sqrt: std="
            + String(ck.get[Float32](col=0, row=0).value())
            + " mojo="
            + String(ck.get[Float32](col=1, row=0).value())
        )
        print(
            "  sin:  std="
            + String(ck.get[Float32](col=2, row=0).value())
            + " mojo="
            + String(ck.get[Float32](col=3, row=0).value())
        )
    ...
    print(
        ...
        + String(ac.get[Bool](col=0, row=0).value())
        + ", sin: "
        + String(ac.get[Bool](col=1, row=0).value())
        + ", cos: "
        + String(ac.get[Bool](col=2, row=0).value())
    )
