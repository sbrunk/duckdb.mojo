...
def test_extension_loads():
    ...
    assert_equal(chunk.get[Int32](col=0, row=0).value(), Int32(1))
...
def test_extension_load_idempotent():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(chunk.get[Int64](col=0, row=0).value(), Int64(3))
...
def test_ext_add_basic():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(chunk.get[Int64](col=0, row=0).value(), Int64(42))
...
def test_ext_add_negative():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(chunk.get[Int64](col=0, row=0).value(), Int64(-7))
...
def test_ext_add_zeros():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(chunk.get[Int64](col=0, row=0).value(), Int64(0))
...
def test_ext_add_large():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(
        chunk.get[Int64](col=0, row=0).value(), Int64(3000000000)
    )
...
def test_ext_multiply_basic():
    ...
    var chunk = result.fetch_chunk()
    assert_almost_equal(
        chunk.get[Float64](col=0, row=0).value(), 21.0, atol=1e-10
    )
...
def test_ext_multiply_fractional():
    ...
    var chunk = result.fetch_chunk()
    assert_almost_equal(
        chunk.get[Float64](col=0, row=0).value(), 0.125, atol=1e-10
    )
...
def test_ext_multiply_negative():
    ...
    var chunk = result.fetch_chunk()
    assert_almost_equal(
        chunk.get[Float64](col=0, row=0).value(), -6.0, atol=1e-10
    )
...
def test_ext_double_negative():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(chunk.get[Int64](col=0, row=0).value(), Int64(-10))
...
def test_ext_sum_basic():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(chunk.get[Int64](col=0, row=0).value(), Int64(55))
...
def test_ext_add_table():
    ...
    assert_equal(chunk.get[Int64](col=0, row=0).value(), Int64(15150))
...
def test_ext_negate_table():
    ...
    var chunk = result.fetch_chunk()
    # -(1+2+3+4+5) = -15
    assert_equal(chunk.get[Int64](col=0, row=0).value(), Int64(-15))
...
def test_ext_multiple_functions_one_query():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(chunk.get[Int64](col=0, row=0).value(), Int64(3))
    assert_equal(chunk.get[Int64](col=1, row=0).value(), Int64(-5))
    assert_equal(chunk.get[Int64](col=2, row=0).value(), Int64(42))
    assert_almost_equal(
        chunk.get[Float64](col=3, row=0).value(), 12.0, atol=1e-10
    )
...
def test_ext_across_connections():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(chunk.get[Int64](col=0, row=0).value(), Int64(30))
