...
struct LibDuckDB(Movable):
    ...
    # Only used when USE_DLHANDLE is True; external_call mode calls C directly.
    var _workaround_create_decimal_ptr: _workaround_create_decimal_ptr.fn_type
    var _workaround_decimal_to_double_ptr: _workaround_decimal_to_double_ptr.fn_type
    var _workaround_double_to_decimal_ptr: _workaround_double_to_decimal_ptr.fn_type
    var _workaround_fetch_chunk_ptr: _workaround_fetch_chunk_ptr.fn_type
    var _workaround_from_date_ptr: _workaround_from_date_ptr.fn_type
    var _workaround_from_time_ptr: _workaround_from_time_ptr.fn_type
    var _workaround_from_time_tz_ptr: _workaround_from_time_tz_ptr.fn_type
    var _workaround_from_timestamp_ptr: _workaround_from_timestamp_ptr.fn_type
    var _workaround_get_decimal_ptr: _workaround_get_decimal_ptr.fn_type
    var _workaround_query_progress_ptr: _workaround_query_progress_ptr.fn_type
    var _workaround_result_statement_type_ptr: _workaround_result_statement_type_ptr.fn_type
    var _workaround_to_date_ptr: _workaround_to_date_ptr.fn_type
    var _workaround_to_time_ptr: _workaround_to_time_ptr.fn_type
    var _workaround_to_timestamp_ptr: _workaround_to_timestamp_ptr.fn_type
    ...
    fn __init__(out self):
        ...
        try:
            ...
            # Always loaded to initialize struct vars; only called when USE_DLHANDLE is True.
            self._workaround_create_decimal_ptr = _workaround_create_decimal_ptr.load()
            self._workaround_decimal_to_double_ptr = _workaround_decimal_to_double_ptr.load()
            self._workaround_double_to_decimal_ptr = _workaround_double_to_decimal_ptr.load()
            self._workaround_fetch_chunk_ptr = _workaround_fetch_chunk_ptr.load()
            self._workaround_from_date_ptr = _workaround_from_date_ptr.load()
            self._workaround_from_time_ptr = _workaround_from_time_ptr.load()
            self._workaround_from_time_tz_ptr = _workaround_from_time_tz_ptr.load()
            self._workaround_from_timestamp_ptr = _workaround_from_timestamp_ptr.load()
            self._workaround_get_decimal_ptr = _workaround_get_decimal_ptr.load()
            self._workaround_query_progress_ptr = _workaround_query_progress_ptr.load()
            self._workaround_result_statement_type_ptr = _workaround_result_statement_type_ptr.load()
            self._workaround_to_date_ptr = _workaround_to_date_ptr.load()
            self._workaround_to_time_ptr = _workaround_to_time_ptr.load()
            self._workaround_to_timestamp_ptr = _workaround_to_timestamp_ptr.load()
        except e:
            abort(String(e))
    ...
    fn __moveinit__(out self, deinit take: Self):
        ...
        self._workaround_decimal_to_double_ptr = take._workaround_decimal_to_double_ptr
        self._workaround_double_to_decimal_ptr = take._workaround_double_to_decimal_ptr
        self._workaround_fetch_chunk_ptr = take._workaround_fetch_chunk_ptr
        self._workaround_from_date_ptr = take._workaround_from_date_ptr
        self._workaround_from_time_ptr = take._workaround_from_time_ptr
        self._workaround_from_time_tz_ptr = take._workaround_from_time_tz_ptr
        self._workaround_from_timestamp_ptr = take._workaround_from_timestamp_ptr
        self._workaround_get_decimal_ptr = take._workaround_get_decimal_ptr
        self._workaround_query_progress_ptr = take._workaround_query_progress_ptr
        self._workaround_result_statement_type_ptr = take._workaround_result_statement_type_ptr
        self._workaround_to_date_ptr = take._workaround_to_date_ptr
        self._workaround_to_time_ptr = take._workaround_to_time_ptr
        self._workaround_to_timestamp_ptr = take._workaround_to_timestamp_ptr
    ...
    fn duckdb_query_progress(
        ...
        """
        comptime if USE_DLHANDLE:
            var result = duckdb_query_progress_type(percentage=Float64(0), rows_processed=UInt64(0), total_rows_to_process=UInt64(0))
            self._workaround_query_progress_ptr(connection, UnsafePointer(to=result).bitcast[NoneType]().unsafe_origin_cast[MutAnyOrigin]())
            return result
        else:
            return external_call["duckdb_query_progress", duckdb_query_progress_type, duckdb_connection](connection)
    ...
    fn duckdb_result_statement_type(
        ...
        """
        comptime if USE_DLHANDLE:
            var _result_copy = result
            return self._workaround_result_statement_type_ptr(UnsafePointer(to=_result_copy).bitcast[NoneType]().unsafe_origin_cast[MutAnyOrigin]())
        else:
            return external_call["duckdb_result_statement_type", duckdb_statement_type, duckdb_result](result)
    ...
    fn duckdb_from_date(
        ...
        """
        comptime if USE_DLHANDLE:
            var result = duckdb_date_struct(year=Int32(0), month=Int8(0), day=Int8(0))
            self._workaround_from_date_ptr(date.days, UnsafePointer(to=result).bitcast[NoneType]().unsafe_origin_cast[MutAnyOrigin]())
            return result
        else:
            return external_call["duckdb_from_date", duckdb_date_struct, duckdb_date](date)
    ...
    fn duckdb_to_date(
        ...
        comptime if USE_DLHANDLE:
            var _date_copy = date
            return duckdb_date(days=self._workaround_to_date_ptr(UnsafePointer(to=_date_copy).bitcast[NoneType]().unsafe_origin_cast[MutAnyOrigin]()))
        else:
            return external_call["duckdb_to_date", duckdb_date, duckdb_date_struct](date)
    ...
    fn duckdb_from_time(
        ...
        """
        comptime if USE_DLHANDLE:
            var result = duckdb_time_struct(hour=Int8(0), min=Int8(0), sec=Int8(0), micros=Int32(0))
            self._workaround_from_time_ptr(time.micros, UnsafePointer(to=result).bitcast[NoneType]().unsafe_origin_cast[MutAnyOrigin]())
            return result
        else:
            return external_call["duckdb_from_time", duckdb_time_struct, duckdb_time](time)
    ...
    fn duckdb_from_time_tz(
        ...
        """
        comptime if USE_DLHANDLE:
            var result = duckdb_time_tz_struct(time=duckdb_time_struct(hour=Int8(0), min=Int8(0), sec=Int8(0), micros=Int32(0)), offset=Int32(0))
            self._workaround_from_time_tz_ptr(micros.bits, UnsafePointer(to=result).bitcast[NoneType]().unsafe_origin_cast[MutAnyOrigin]())
            return result
        else:
            return external_call["duckdb_from_time_tz", duckdb_time_tz_struct, duckdb_time_tz](micros)
    ...
    fn duckdb_to_time(
        ...
        comptime if USE_DLHANDLE:
            var _time_copy = time
            return duckdb_time(micros=self._workaround_to_time_ptr(UnsafePointer(to=_time_copy).bitcast[NoneType]().unsafe_origin_cast[MutAnyOrigin]()))
        else:
            return external_call["duckdb_to_time", duckdb_time, duckdb_time_struct](time)
    ...
    fn duckdb_from_timestamp(
        ...
        """
        comptime if USE_DLHANDLE:
            var result = duckdb_timestamp_struct(date=duckdb_date_struct(year=Int32(0), month=Int8(0), day=Int8(0)), time=duckdb_time_struct(hour=Int8(0), min=Int8(0), sec=Int8(0), micros=Int32(0)))
            self._workaround_from_timestamp_ptr(ts.micros, UnsafePointer(to=result).bitcast[NoneType]().unsafe_origin_cast[MutAnyOrigin]())
            return result
        else:
            return external_call["duckdb_from_timestamp", duckdb_timestamp_struct, duckdb_timestamp](ts)
    ...
    fn duckdb_to_timestamp(
        ...
        comptime if USE_DLHANDLE:
            var _ts_copy = ts
            return duckdb_timestamp(micros=self._workaround_to_timestamp_ptr(UnsafePointer(to=_ts_copy).bitcast[NoneType]().unsafe_origin_cast[MutAnyOrigin]()))
        else:
            return external_call["duckdb_to_timestamp", duckdb_timestamp, duckdb_timestamp_struct](ts)
    ...
    fn duckdb_double_to_decimal(
        ...
        comptime if USE_DLHANDLE:
            ...
            self._workaround_double_to_decimal_ptr(val, width, scale, UnsafePointer(to=result).bitcast[NoneType]().unsafe_origin_cast[MutAnyOrigin]())
            return result
        else:
            return external_call["duckdb_double_to_decimal", duckdb_decimal, Float64, UInt8, UInt8](val, width, scale)
    ...
    fn duckdb_decimal_to_double(
        ...
        comptime if USE_DLHANDLE:
            var _val_copy = val
            return self._workaround_decimal_to_double_ptr(UnsafePointer(to=_val_copy).bitcast[NoneType]().unsafe_origin_cast[MutAnyOrigin]())
        else:
            return external_call["duckdb_decimal_to_double", Float64, duckdb_decimal](val)
    ...
    fn duckdb_create_decimal(
        ...
        """
        comptime if USE_DLHANDLE:
            var _input__copy = input_
            return self._workaround_create_decimal_ptr(UnsafePointer(to=_input__copy).bitcast[NoneType]().unsafe_origin_cast[MutAnyOrigin]())
        else:
            return external_call["duckdb_create_decimal", duckdb_value, duckdb_decimal](input_)
    ...
    fn duckdb_get_decimal(
        ...
        comptime if USE_DLHANDLE:
            var result = duckdb_decimal(width=UInt8(0), scale=UInt8(0), value=Int128(0))
            self._workaround_get_decimal_ptr(val, UnsafePointer(to=result).bitcast[NoneType]().unsafe_origin_cast[MutAnyOrigin]())
            return result
        else:
            return external_call["duckdb_get_decimal", duckdb_decimal, duckdb_value](val)
    ...
    fn duckdb_fetch_chunk(
        ...
        comptime if USE_DLHANDLE:
            var _result_copy = result
            return self._workaround_fetch_chunk_ptr(UnsafePointer(to=_result_copy).bitcast[NoneType]().unsafe_origin_cast[MutAnyOrigin]())
        else:
            return external_call["duckdb_fetch_chunk", duckdb_data_chunk, duckdb_result](result)
...
# ===--------------------------------------------------------------------===#
# Struct Workaround Functions (libduckdb_mojo_helpers)
# ===--------------------------------------------------------------------===#

# C shims for functions that pass/return multi-field structs by value.
# See https://github.com/modular/modular/issues/3144

comptime _workaround_create_decimal_ptr = _dylib_helpers_function["workaround_create_decimal_ptr",
    fn (UnsafePointer[NoneType, MutAnyOrigin]) -> duckdb_value
]

comptime _workaround_decimal_to_double_ptr = _dylib_helpers_function["workaround_decimal_to_double_ptr",
    fn (UnsafePointer[NoneType, MutAnyOrigin]) -> Float64
]

comptime _workaround_double_to_decimal_ptr = _dylib_helpers_function["workaround_double_to_decimal_ptr",
    fn (Float64, UInt8, UInt8, UnsafePointer[NoneType, MutAnyOrigin]) -> NoneType
]

comptime _workaround_fetch_chunk_ptr = _dylib_helpers_function["workaround_fetch_chunk_ptr",
    fn (UnsafePointer[NoneType, MutAnyOrigin]) -> duckdb_data_chunk
]

comptime _workaround_from_date_ptr = _dylib_helpers_function["workaround_from_date_ptr",
    fn (Int32, UnsafePointer[NoneType, MutAnyOrigin]) -> NoneType
]

comptime _workaround_from_time_ptr = _dylib_helpers_function["workaround_from_time_ptr",
    fn (Int64, UnsafePointer[NoneType, MutAnyOrigin]) -> NoneType
]

comptime _workaround_from_time_tz_ptr = _dylib_helpers_function["workaround_from_time_tz_ptr",
    fn (UInt64, UnsafePointer[NoneType, MutAnyOrigin]) -> NoneType
]

comptime _workaround_from_timestamp_ptr = _dylib_helpers_function["workaround_from_timestamp_ptr",
    fn (Int64, UnsafePointer[NoneType, MutAnyOrigin]) -> NoneType
]

comptime _workaround_get_decimal_ptr = _dylib_helpers_function["workaround_get_decimal_ptr",
    fn (duckdb_value, UnsafePointer[NoneType, MutAnyOrigin]) -> NoneType
]

comptime _workaround_query_progress_ptr = _dylib_helpers_function["workaround_query_progress_ptr",
    fn (duckdb_connection, UnsafePointer[NoneType, MutAnyOrigin]) -> NoneType
]

comptime _workaround_result_statement_type_ptr = _dylib_helpers_function["workaround_result_statement_type_ptr",
    fn (UnsafePointer[NoneType, MutAnyOrigin]) -> duckdb_statement_type
]

comptime _workaround_to_date_ptr = _dylib_helpers_function["workaround_to_date_ptr",
    fn (UnsafePointer[NoneType, MutAnyOrigin]) -> Int32
]

comptime _workaround_to_time_ptr = _dylib_helpers_function["workaround_to_time_ptr",
    fn (UnsafePointer[NoneType, MutAnyOrigin]) -> Int64
]

comptime _workaround_to_timestamp_ptr = _dylib_helpers_function["workaround_to_timestamp_ptr",
    fn (UnsafePointer[NoneType, MutAnyOrigin]) -> Int64
]
