...
def test_scalar_function_highlevel_types():
    ...
    assert_equal(chunk1.get[Int32](col=0, row=0).value(), 100)
    ...
    assert_equal(chunk2.get[Int32](col=0, row=0).value(), 2)
    assert_equal(chunk2.get[Int32](col=0, row=1).value(), 3)
    assert_equal(chunk2.get[Int32](col=0, row=2).value(), 4)
    assert_equal(chunk2.get[Int32](col=0, row=3).value(), 5)
    assert_equal(chunk2.get[Int32](col=0, row=4).value(), 6)
...
def test_scalar_function_auto_wrapped():
    ...
    var chunk2 = result2.fetch_chunk()
    assert_equal(chunk2.get[Int32](col=0, row=0).value(), 11)
    assert_equal(chunk2.get[Int32](col=0, row=1).value(), 21)
    assert_equal(chunk2.get[Int32](col=0, row=2).value(), 31)
...
def test_scalar_function_fully_highlevel():
    ...
    var chunk1 = result1.fetch_chunk()
    assert_equal(chunk1.get[Int32](col=0, row=0).value(), 43)
    ...
    var chunk2 = result2.fetch_chunk()
    assert_equal(chunk2.get[Int32](col=0, row=0).value(), 101)
    assert_equal(chunk2.get[Int32](col=0, row=1).value(), 201)
    assert_equal(chunk2.get[Int32](col=0, row=2).value(), 301)
...
def test_scalar_function_execute_from_table():
    ...
    assert_equal(chunk.get[Int32](col=0, row=0).value(), 2)   # 1+1
    assert_equal(chunk.get[Int32](col=0, row=1).value(), 3)   # 2+1
    assert_equal(chunk.get[Int32](col=0, row=2).value(), 4)   # 3+1
    assert_equal(chunk.get[Int32](col=0, row=3).value(), 11)  # 10+1
...
def test_scalar_function_float_type():
    ...
    var chunk = result.fetch_chunk()
    var value = chunk.get[Float32](col=0, row=0).value()
...
def test_scalar_function_set_multiple_overloads():
    ...
    var chunk1 = result1.fetch_chunk()
    assert_equal(chunk1.get[Int32](col=0, row=0).value(), 42)
    
    # Test float overload
    var result2 = conn.execute("SELECT my_add(20.5::FLOAT, 21.5::FLOAT) as answer")
    var chunk2 = result2.fetch_chunk()
    var value = chunk2.get[Float32](col=0, row=0).value()
    assert_true(abs(value - 42.0) < 0.001)
...
def test_multiple_functions_same_connection():
    ...
    assert_equal(chunk.get[Int32](col=0, row=0).value(), 41)
    var b_val = chunk.get[Float32](col=1, row=0).value()
...
def test_function_reuse_across_queries():
    ...
    var chunk1 = result1.fetch_chunk()
    assert_equal(chunk1.get[Int32](col=0, row=0).value(), 11)
    
    var result2 = conn.execute("SELECT add_one(20) as val")
    var chunk2 = result2.fetch_chunk()
    assert_equal(chunk2.get[Int32](col=0, row=0).value(), 21)
    
    var result3 = conn.execute("SELECT add_one(100) as val")
    var chunk3 = result3.fetch_chunk()
    assert_equal(chunk3.get[Int32](col=0, row=0).value(), 101)
...
def test_function_outlives_connection():
    ...
    var chunk2 = result2.fetch_chunk()
    assert_equal(chunk2.get[Int32](col=0, row=0).value(), 100)
...
def test_create_on_table():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(chunk.get[Int32](col=0, row=0).value(), 2)
    assert_equal(chunk.get[Int32](col=0, row=1).value(), 3)
    assert_equal(chunk.get[Int32](col=0, row=2).value(), 4)
...
def test_from_function_binary_float():
    ...
    var chunk = result.fetch_chunk()
    var value = chunk.get[Float64](col=0, row=0).value()
    assert_true(abs(value - 42.0) < 0.001)
...
def test_from_function_on_table():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(chunk.get[Int32](col=0, row=0).value(), 11)
    assert_equal(chunk.get[Int32](col=0, row=1).value(), 21)
    assert_equal(chunk.get[Int32](col=0, row=2).value(), 31)
...
def test_from_simd_function_on_table():
    ...
    assert_equal(chunk.get[Int32](col=0, row=1).value(), 3)
    assert_equal(chunk.get[Int32](col=0, row=2).value(), 4)
    assert_equal(chunk.get[Int32](col=0, row=3).value(), 5)
    assert_equal(chunk.get[Int32](col=0, row=4).value(), 6)
    assert_equal(chunk.get[Int32](col=0, row=5).value(), 7)
    assert_equal(chunk.get[Int32](col=0, row=6).value(), 8)
...
def test_from_simd_function_large_table():
    ...
    assert_equal(chunk.get[Int32](col=0, row=1).value(), 3)
    assert_equal(chunk.get[Int32](col=0, row=2).value(), 6)
    assert_equal(chunk.get[Int32](col=0, row=3).value(), 9)
    assert_equal(chunk.get[Int32](col=0, row=4).value(), 12)
...
def test_from_simd_function_stdlib_unary():
    ...
    var chunk = result.fetch_chunk()
    assert_almost_equal(chunk.get[Float64](col=0, row=0).value(), 4.0)
...
def test_from_simd_function_stdlib_sin():
    ...
    var chunk = result.fetch_chunk()
    assert_almost_equal(chunk.get[Float64](col=0, row=0).value(), 0.0)
...
def test_from_simd_function_stdlib_on_table():
    ...
    var chunk = result.fetch_chunk()
    assert_almost_equal(chunk.get[Float64](col=0, row=0).value(), 1.0)
...
def test_from_simd_function_stdlib_matches_builtin():
    ...
    var chunk = result.fetch_chunk()
    assert_almost_equal(chunk.get[Float64](col=0, row=0).value(), 0.0, atol=1e-6)
    ...
    var chunk2 = result2.fetch_chunk()
    assert_almost_equal(chunk2.get[Float64](col=0, row=0).value(), 0.0, atol=1e-6)
