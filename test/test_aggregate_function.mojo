...
def test_aggregate_function_sum_single_value():
    ...
    assert_equal(chunk.get[Int64](col=0, row=0).value(), 42)
...
def test_aggregate_function_sum_table():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(chunk.get[Int64](col=0, row=0).value(), 15)
...
def test_aggregate_function_sum_empty_table():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(chunk.get[Int64](col=0, row=0).value(), 0)
...
def test_aggregate_function_sum_with_groups():
    ...
    # Group 'a': 1+2=3
    assert_equal(chunk.get[Int64](col=1, row=0).value(), 3)
    # Group 'b': 10+20+30=60
    assert_equal(chunk.get[Int64](col=1, row=1).value(), 60)
...
def test_aggregate_function_sum_large_input():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(chunk.get[Int64](col=0, row=0).value(), 12502500)
...
def test_aggregate_function_count():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(chunk.get[Int64](col=0, row=0).value(), 4)
...
def test_aggregate_function_avg():
    ...
    var chunk = result.fetch_chunk()
    assert_almost_equal(chunk.get[Float64](col=0, row=0).value(), 25.0)
...
def test_aggregate_function_avg_with_groups():
    ...
    assert_equal(len(chunk), 2)
    # Group 'a': (2+4)/2 = 3.0
    assert_almost_equal(chunk.get[Float64](col=1, row=0).value(), 3.0)
    # Group 'b': 100/1 = 100.0
    assert_almost_equal(chunk.get[Float64](col=1, row=1).value(), 100.0)
...
def test_aggregate_function_in_subquery():
    ...
    assert_equal(chunk.get[Int64](col=0, row=0).value(), 6)
...
def test_aggregate_function_set_register():
    ...
    assert_equal(chunk1.get[Int64](col=0, row=0).value(), 6)
    ...
    assert_almost_equal(chunk2.get[Float64](col=0, row=0).value(), 7.0)
...
def test_aggregate_function_sum_matches_builtin():
    ...
    var chunk = result.fetch_chunk()
    assert_equal(
        chunk.get[Int64](col=0, row=0).value(),
        chunk.get[Int64](col=1, row=0).value(),
    )
